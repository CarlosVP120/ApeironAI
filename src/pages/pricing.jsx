...
const BlogLight = () => {
  ...
  return (
    <DarkTheme>
      ...
      <PageHeader
        title="Pricing"
        paragraph="The most affordable and flexible pricing plans for you."
      />
      <div className="tw-justify-center tw-flex tw-w-full tw-flex-col tw-gap-6 ">
        <div className="tw-justify-center tw-self-center tw-flex tw-gap-10 tw-flex-col md:tw-flex-row">
          <div className="tw-flex tw-relative tw-group tw-max-w-sm">
            ...
            ></div>
            <button className="tw-relative tw-px-2 tw-py-4 tw-bg-black tw-cursor-default tw-rounded-lg tw-leading-none tw-flex tw-flex-col tw-items-center">
              <div className="tw-text-white tw-text-2xl tw-font-bold tw-mb-4 tw-hidden md:tw-block">
                ...
                <p className="tw-flex tw-flex-col tw-justify-center tw-items-center">
                  ...
                  <p className="tw-text-sm tw-text-gray-400 tw-font-bold tw-text-center tw-max-w-[19vw] tw-my-3">
                    ...
                    problems, and learn how to code better with our AI-powered
                    tool.
                  </p>
                </p>
              </div>
            ...
            <button className="tw-relative tw-px-2 tw-py-4 tw-bg-black tw-cursor-default tw-rounded-lg tw-leading-none tw-flex tw-flex-col tw-items-center">
              <div className="tw-text-white tw-text-2xl tw-font-bold tw-mb-4 tw-hidden md:tw-block">
                ...
                <p className="tw-flex tw-flex-col tw-justify-center tw-items-center">
                  ...
                  <p className="tw-text-sm tw-text-gray-400 tw-font-bold tw-text-center tw-max-w-[19vw] tw-my-3">
                    With MarkeX, find the best description for your products and
                    create the best ads for your business.
                  </p>
                </p>
              </div>
              <div className="tw-flex tw-gap-2 tw-text-white tw-text-sm tw-font-bold tw-divide-x tw-divide-gray-600">
            ...
            <button className="tw-relative tw-px-2 tw-py-4 tw-bg-black tw-cursor-default tw-rounded-lg tw-leading-none tw-flex tw-flex-col tw-items-center  ">
              <div className="tw-text-white tw-text-2xl tw-font-bold tw-mb-4 tw-hidden md:tw-block">
                ...
                <p className="tw-flex tw-flex-col tw-justify-center tw-items-center">
                  ...
                  <p className="tw-text-sm tw-text-gray-400 tw-font-bold tw-text-center tw-max-w-[19vw] tw-my-3">
                    With ArtiX, you can create your own images, and the best of
                    all, you can do it in a simple way: Imaginating.
                  </p>
                </p>
              </div>
              <div className="tw-flex tw-gap-2 tw-text-white tw-text-sm tw-font-bold tw-divide-x tw-divide-gray-600">
      ...
      <div className="tw-relative tw-px-7  tw-mt-14  tw-rounded-lg tw-leading-none tw-flextw-items-center tw-flex tw-justify-center tw-gap-3 tw-mb-40">
        <button className="tw-bg-neutral-800 tw-px-4 tw-py-2 tw-text-xl tw-rounded-lg tw-font-bold tw-transition tw-duration-500 hover:tw-bg-neutral-900 tw-shadow hover:tw-shadow-indigo-500/50 hover:tw-shadow-md ">
          <Link href="/login">
            <a>
              <span className={styles.color_font}>
                Get all for $18/mo or each for $5/mo
              </span>
            </a>
          </Link>
        </button>
