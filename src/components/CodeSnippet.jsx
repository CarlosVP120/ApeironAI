    ...
    <div className="tw-w-full tw-h-[100vh] tw-bg-black tw-text-white tw-flex tw-justify-center">
      <div className="tw-h-full tw-flex tw-flex-col tw-pt-4 tw-gap-4">
        ...
        <div className="tw-font-bold tw-text-white tw-mt-4 tw-flex tw-justify-center tw-shadow-inner">
          <div className="tw-bg-neutral-900 tw-py-8 tw-rounded-lg tw-text-left tw-text tw-flex tw-px-8 tw-flex-col">
          ...
          <div className="tw-bg-neutral-800 tw-py-8 tw-rounded-lg tw-text-left tw-text tw-px-8">
            <h1 className="tw-flex tw-items-center tw-text-2xl">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
        ...
        <div className="tw-font-bold tw-text-white tw-mt-2 tw-flex tw-justify-center tw-shadow-inner tw-gap-4">
          <button className="tw-mt-4 tw-p-4 tw-rounded-lg tw-text-black tw-bg-gray-100">
            Explain Code
          </button>
          <button className="tw-mt-4 tw-p-4 tw-rounded-lg tw-text-black tw-bg-gray-100">
            Convert Code
